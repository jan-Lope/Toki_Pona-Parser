%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Unofficial words - Persons (prominent personage)
% Include File
...
person_catalog(famous_person(Person_catalog),Person_catalog) --> [Person_catalog], { member(Person_catalog, [ 
     'Bogy',               % bogy
     'Demon',              % demaon
     'Devil',              % devil 
     'God'                 % God
